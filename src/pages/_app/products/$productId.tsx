...
function RouteComponent() {
	...
	return (
		<section className="container mb-10 pt-44 md:pt-54 pd-10 md:px-1">
			<nav className="text-black text-sm mb-15 ml-5">
				<Link to="/">Home</Link> / <Link to="/products">Produtos</Link> / <span className="font-semibold"></span>
			</nav>
			...
			<div className="flex justify-center gap-10">
				...
				<div className="text-black">
					...
					<p className="">
						Ou em <span className="text-[#38373a] font-semibold">6x</span> de{" "}
